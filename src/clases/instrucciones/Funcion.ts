...
export default class Funcion extends Simbolos implements Instruccion{
    ...
    constructor(simbolo: number, tipo: Tipo, identificador: string, lista_params:Array<Simbolos>, metodo:boolean, lista_instrucciones : Array<Instruccion>, linea: number, columna: number ) {
